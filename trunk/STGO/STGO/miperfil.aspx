...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="PanelDatosModificarId" runat="server" DefaultButton="InvisibleButtonDatosModificarId">
        <asp:Button ID="InvisibleButtonDatosModificarId" runat="server" Visible="false" />
        <div class="grid_7">
            <h1>
                Mis datos</h1>
            <p>
            ...
            <div class="grid_3 omega">
                ...
                <asp:CustomValidator ID="customRazonSocial" runat="server" ValidationGroup="valGrupoEdicion"
                    Display="Dynamic" ControlToValidate="txtRazonSocial" ErrorMessage="El nombre no puede tener más de 100 caracteres"
                    ClientValidationFunction="validaLargo100"></asp:CustomValidator>
            </div>
            <div class="clear">
            </div>
            <div class="grid_2 divlabel alpha">
            ...
            <div class="grid_3 omega">
                ...
                <asp:RegularExpressionValidator ID="revCuitReg" ErrorMessage="El formato del Cuit es inválido."
                    ToolTip="Ingrese el CUIT. Ej: 99-99999999-9." ControlToValidate="txtCuit" runat="server"
                    ValidationExpression="\d{2}-\d{8}-\d" ValidationGroup="valGrupoEdicion" Display="Dynamic" /></div>
            <div class="clear">
            </div>
            <div class="grid_2 divlabel alpha">
    ...
    <asp:Panel ID="PanelResetPasswordId" runat="server" DefaultButton="InvisibleButtonDatosModificarId">
        <div class="grid_5">
            <h1>
        ...
        <asp:Button ID="InvisibleButtonResetPasswordId" runat="server" Visible="false" />
    </asp:Panel>
</asp:Content>
